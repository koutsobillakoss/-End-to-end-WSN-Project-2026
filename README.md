...
```
Έπειτα γίνεται στατιστική ανάλυση με την εντολή ".describe", παρατηρούμε ότι οι τιμές θερμοκρασίας δεν είναι λογικές, αφού δεν γίνεται ο μέσος όρος να είναι 3.4 βαθμοί και η μικρότερη τιμή -32 βαθμοι. Γι αυτό εφαρμόζουμε την διαγραφή outliers, έτσι ώστε οι προβλέψεις να μην επιρρεαστούν αρνητικά από αδυναμίες του hardware. Θέτονται λοιπόν περιορισμοί που διαγράφουν παράλογες τιμές. Όπως φαίνεται παρακάτω, εντοπίστηκαν πολλά λάθος δεδομένα στα πεδία των θερμοκρασιών. 
``` bash
...
```
Πιο συγκεκριμένα, παρατηρούμε από το παρακάτω διάγραμμα, ότι οι μετρήσεις έδιναν πολλές φορές θερμοκρασία περίπου -30, πιθανόν επηρεασμένη από τον χρόνο που έμενε ανοιχτός ο αισθητήρας. Επιπλέον από κάτω παρατηρούμε τις τιμές που παραμένουν, αφού αφαιρέσουμε τις ακραίες.

<img src="./images_github/Screenshot 2026-05-22 154739.png" alt=" ">

<img src="./images_github/Screenshot 2026-05-22 155139.png" alt=" ">

Τέλος, η πρόβλεψη υλοποιείται με δύο μεθόδους μηχανικής μάθησης, που εκπαιδεύονται από τις καθαρισμένες τιμές. 
1. Πρώτη μέθοδος, είναι η Γραμμική Παλινδρόμηση. Ο στόχος είναι να εκπαιδευτεί ένα μοντέλο από ένα σύνολο σημείων και να ορίσει ένα ευθύγραμμο τμήμα που θα ακολουθεί τις τιμές που θέλει να προβλέψει. Μια πολύ σημαντική παράμετρος, είναι το όρισμα Shuffle=True/False, όπου εφαρμόζεται ανακάτεμα των δεδομένων και είναι σημαντικό για μη χρονικώς εξαρτημένα δεδομένα. Στην παρούσα υλοποίηση, παρατηρήθηκε ότι η πρόβλεψη με γραμμική παλινδρόμηση, χωρίς ανακάτεμα, προκαλούσε την αύξηση της τιμής λάθους, αφού πρόβλεπε μια συνεχή αύξηση ή μείωση της θερμοκρασίας. Για τον παραπάνω λόγο, δοκιμάστηκε και η πρόβλεψη με ανακάτεμα, ακόμα και αν οι τιμές ήταν χρονικά εξαρτημένες. Έτσι οι τιμές δεν απέχουν πολύ από το κανονικό. Μπορόυμε να συμπεράνουμε ότι αυτό ευθύνεται στο διάστημα δειγματοληψίας, αφού οι αισθητήρες πήραν τιμές μόνο από λίγες μέρες και όχι σε βάθος πολλών μηνών. Αν δηλαδή οι αισθητήρες εκπαιδεύονταν με δεδομένα των μηνών Απριλίου , Μαίου, θα πρόβλεπε ορθά γραμμική αύξηση. Από την άλλη, τα αποτελέσματα για την πρόβλεψη υγρασίας, είχαν καλύτερα αποτελέσματα χωρίς το ανακάτεμα. Τα διαγράμματα καθώς και οι τιμές φαίνονται παρακάτω.
Για την θερμοκρασία:

<img src="./images_github/Screenshot 2026-05-22 161659.png" alt=" ">

Για την υγρασία:

<img src="./images_github/Screenshot 2026-05-22 161846.png" alt=" ">

2. Η δέυτερη μέθοδος είναι η ARIMA. Αυτή η μέθοδος κοιτάζει όλες τις τιμές του συνόλου εκπαίδευσης καθώς και τις χρονικές στιγμές, για να καταλάβει κυκλικότητα και τάσεις στις τιμές. Οι προβλέψεις που δίνονται, είναι ραελιστικές και βασίζονται στην μελέτη των 500 πιό πρόσφατων τιμών. Έχει οριστεί το p=5, το οποίο σημαίνει ότι για να προβλέψει το μοντέλο την τιμή #501 , κοιτάει τις τιμές #500-$496 και έπειτα κινεί το "παράθυρο" τιμών κατά ένα, δηλαδή #499-#495. Στην παρούσα εργασία, το μοντέλο καλείται να προβλέψει τις επόμενες 20 τιμές, που απεικονίζονται και στα διαγράμματα.
Για την Θερμοκρασία:

<img src="./images_github/Screenshot 2026-05-22 164635.png" alt=" ">
...
How to Install VirtualBox on Windows 11 - https://www.youtube.com/watch?v=s3BM4dgn_Is
